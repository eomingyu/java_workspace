...
//자바에서는 awt,swing,javaFX 등을 이용해서 GUI(windows 프로그램) 방식으로 프로그램을 만듭니다.
...
public class GuiMain extends JFrame implements ActionListener{
	...
	private void init() {
		...
		//버튼들에게 action listener가 어디에 있는지 알려주기
		...
		this.setResizable(false);	//윈도우 크기 조정
	...
	@Override
	public void actionPerformed(ActionEvent e) {	//이벤트(사건) 일어난 객체 정보가 인자입니다.
