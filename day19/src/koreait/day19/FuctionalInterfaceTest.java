...
//		자바에서는 람다식이라고도 부릅니다. 가독성, 간결성을 위해서 사용합니다.	
	...
	public static void main(String[] args) {
		...
		//함수형 인터페이스를 익명 클래스보다 더 간단한 형식으로 하는 람다식은 아래와 같습니다.
		
		w = (String url) ->{System.out.println("Your searching : "+url+ " !!");};
		w.search("Youtube");
		
		//FuncInterfaceA 1)익명클래스로 객체 생성한다. 
		...
		//2)람다식으로 객체를 생성한다. 추상 메소드는 두 개의 정수값을 범위로 하여 난수를 만들고 리턴합니다.
		//	추상 메소드가 여러 개인 인터페이스는 람다식으로 못합니다.
		fia = (int a, int b) -> {
			Random r = new Random();
