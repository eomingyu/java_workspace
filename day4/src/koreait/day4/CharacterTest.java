...
public class CharacterTest {	//언어별로 사용하는 문자는 컴퓨터로 처리하는 문자 인코딩을 위한 문자 코드가 있습니다.
	...
	public static void main(String[] args) {
		char ch1 = 'a'; //리터럴은 작은 따움표
		char ch2 = 97;	//char형식은 정수값으로는 0~65335까지 저장할 수 있습니다.(2바이트)

		//예를 들면 한글은 AC00 ~ D7A3
		char ch3 = '\uac00'; //16진수 표기, 유니코드 표기:\\u이고 ac00은 16진수 값 1자리 4비트
		...
		System.out.println("한글 uft-8 코드 마지막 글자 : 힣");
		ch3 = '힣';
		ch4 = '\ud7a3';
		ch5 = 55203;		
		System.out.println("ch3=" + ch3);
...
//		ch1 = (char)(ch1+1);
		...
		ch1++; //ch1변수값에 1을 더해서 다시 ch1에 저장합니다. (자동 캐스팅)
