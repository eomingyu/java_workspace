...
//	final int test;		//오류. final 변수는 꼭 초기값을 저장합니다.
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			if(k==12) break;
			System.out.println("sum = " + sum);  //main 메소드 { } 안에서 어디에서나 사용 가능
		}
		
//		System.out.println("k = " + k);	//오류: 선언된 { } 지역을 벗어났습니다.
		System.out.println("전역변수 gval = " + gval);	//gval이 static 아니여서 오류 6라인 앞에 static 붙여야함

		System.out.println("final 변수 fval2 = " + fval2);
//		fval2 = 123;		//***final 변수는 값을 변경할 수 없습니다. 
