...
public class GirlGroupTest {
	...
	public static void main(String[] args) { //GirlGroup 클래스를 활용합니다.
		
		System.out.println("static 필드값 확인");	//static : 고유한 상태
		...
		stacy.year = sc.nextInt();	//nextInt()는 인스턴스 메소드 -> 객체참조변수.메소드명으로 실행함.
